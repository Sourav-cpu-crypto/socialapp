...
$p='s2';
	$sql12 = "SELECT * FROM groups,users where   groups.group_creator_id=users.id and (status!='deactive' or status!='delete') ";
  ...
  while($row2 = mysqli_fetch_assoc($result2))
{
	...
	echo'
		...
		<tr>
			<td>'.$g_n.' <a href="../index2.php?group_id='.$g_c_id1.'" class="del_btn">&nbspGROUP ACTIVE</a></td>
        ...
        $sql123 = "SELECT * FROM groups_members_active where  (group_id='".$g_c_id1."' and group_requester_id='".$_SESSION["id"]."')  AND (status='active' OR status='requested')";
        ...
        while($row3 = mysqli_fetch_assoc($result23))
        {
            ...
            echo'
                ...
                <tr>
                    ...
                    <td>
                        <a href="../index2.php?group_id='.$g_c_id1.'"" class="del_btn">'.$row3['status'].'</a>
                    </td>
            ...
            else if($row3['status']=='requested' )
            {
                ...
                <tr>
                    ...
                    <td>
                        <a href="" class="del_btn">group request sent</a>
                    </td>
            ...
            while($row3 = mysqli_fetch_assoc($result23))
            {
                ...
                echo'
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="joined.php?join='.$g_c_id1.'" class="del_btn">JOIN NOW</a>
                        </td>
